...
import {BarChart, Gamepad2, LogOut, Users} from "lucide-react";
			...
			>
				...
				<div className="flex items-center space-x-4">
					...
					>
						...
						<h1
							className="text-2xl font-bold bg-gradient-to-r from-yellow-300 to-pink-400 bg-clip-text text-transparent drop-shadow-glow">Know
							Your Friends</h1>
					</motion.div>
				</div>
